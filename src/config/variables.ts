const DEV_SESSION_SECRET =
  "0cfca1d1875a2b4d9742be6ae4603fd7bfac19012b03072649c352aaaa26e5c1";
...
const variables = {
  ...
  DASHBOARD_CACHE_TTL_SECONDS: (() => {
    ...
    if (
      ...
      throw new Error(
        "DASHBOARD_CACHE_TTL_SECONDS must be an integer from 5 to 3600",
      );
    }
    return value;
  })(),
  GITHUB_REPOSITORY_CACHE_TTL_SECONDS: (() => {
    ...
    if (
      ...
      throw new Error(
        "GITHUB_REPOSITORY_CACHE_TTL_SECONDS must be an integer from 60 to 86400",
      );
    }
    return value;
  })(),
  DASHBOARD_REQUEST_TIMEOUT_MS: (() => {
    ...
    if (
      ...
      throw new Error(
        "DASHBOARD_REQUEST_TIMEOUT_MS must be an integer from 1000 to 30000",
      );
    }
    return value;
  })(),
